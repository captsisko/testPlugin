...
namespace Drupal\testplugin\Plugin\CKEditor5Plugin;
...
class EmbeddedContent extends CKEditor5PluginDefault {
  ...
  public function getDynamicPluginConfig(array $static_plugin_config, EditorInterface $editor): array {
    $embedded_content_dialog_url = Url::fromRoute('testplugin.dialog')
      ->toString(TRUE)
      ->getGeneratedUrl();
    $static_plugin_config['embeddedContent']['dialogURL'] = $embedded_content_dialog_url;
    $embedded_content_preview_url = Url::fromRoute('testplugin.preview', [
      'editor' => $editor->id(),
    ])
      ->toString(TRUE)
      ->getGeneratedUrl();
