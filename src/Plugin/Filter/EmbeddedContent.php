...
namespace Drupal\testplugin\Plugin\Filter;
 ...
 *   description = @Translation("[TestPlugin] : Converts < embedded-content > tags to results."),
...
//      $container->get('plugin.manager.testplugin')
      $container->get('plugin.manager.testplugin')
    );
  }
